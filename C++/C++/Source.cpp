...
public:
	...
	//Перегрузка оператора скалярного умножения векторов
	...
	//Перегрузка оператора деления вектора на константу (деление int на int значения могут не совпадать)
	Vector operator/ (int con)
	{
		Vector tmp;
